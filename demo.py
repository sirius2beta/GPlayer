...
video_pipeline = 'v4l2src device=/dev/video0 num-buffers=600 ! video/x-raw, format=YUY2, width=640, height=480, framerate=30/1! videoconvert ! video/x-raw,format=BGR ! appsink'
...
out_send = cv2.VideoWriter('appsrc !  videoconvert ! nvv4l2h264enc ! rtph264pay pt=96 config-interval=1 ! udpsink host=100.117.209.85 port=5240 '\
         ,cv2.CAP_GSTREAMER\
         ,0\
         , 30\
         , (1920, 1080)\
